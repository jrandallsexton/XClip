<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/main.master" CodeFile="webm.aspx.cs" Inherits="webm" %>
<asp:Content ID="head" ContentPlaceHolderID="hd" runat="server">
    <title>ASP.NET Media Handler Pro - WebM Encoding Example</title>
</asp:Content>
...
<div style="padding-left: 30px;">
     <script type="text/javascript">
         ...
         function GetProgressValue(intervalid) {
             $.ajax({
                 type: "POST",
                 url: "webm.aspx/GetProgressStatus",
                 data: "{}",
                 contentType: "application/json; charset=utf-8",
                 dataType: "json",
                 success: function (msg) {
     ...
     <div class="item_pad_2">
        ...
        <div class="item_pad_2">
            ...
            <br />
            Output File Name: /contents/mp4/wildlife.webm
        </div>
