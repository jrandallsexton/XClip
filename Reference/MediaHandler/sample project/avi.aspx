<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/main.master" CodeFile="avi.aspx.cs" Inherits="avi" %>
<asp:Content ID="head" ContentPlaceHolderID="hd" runat="server">
    <title>ASP.NET Media Handler Pro - AVI Encoding</title>
</asp:Content>
 ...
 <div style="padding-left: 30px;">
      <script type="text/javascript">
          ...
          function GetProgressValue(intervalid) {
              $.ajax({
                  type: "POST",
                  url: "avi.aspx/GetProgressStatus",
                  data: "{}",
                  contentType: "application/json; charset=utf-8",
                  dataType: "json",
                  success: function (msg) {
     ...
     <div class="item_pad_2">
        ...
        <div class="item_pad_2">
            ...
            <br />
            Output File Name: /contents/mp4/wildlife.avi
        </div>
