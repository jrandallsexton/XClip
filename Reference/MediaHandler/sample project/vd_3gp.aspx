<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/main.master" CodeFile="vd_3gp.aspx.cs"
    Inherits="vd_3gp" %>

<asp:Content ID="head" ContentPlaceHolderID="hd" runat="server">
    <title>ASP.NET Media Handler Pro - 3GP Encoding</title>
</asp:Content>
    ...
    <div style="padding-left: 30px;">
        <script type="text/javascript">
            ...
            function GetProgressValue(intervalid) {
                $.ajax({
                    type: "POST",
                    url: "vd_3gp.aspx/GetProgressStatus",
                    data: "{}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (msg) {
            ...
            function FetchInfo() {
                $.ajax({
                    type: "POST",
                    url: "vd_3gp.aspx/GetInformation",
                    data: "{}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (msg) {
        ...
        <div class="item_pad_2">
            ...
            <br />
            Output File Name: /contents/mp4/wildlife.3gp
        </div>
        <div id="vprocess" style="padding-top: 30px; width: 400px;">
            <div id="msg">
            </div>
            <div id="pbar" style="display: none;">
                ...
                <div class="item_pad_2 medium-text bold black">
                    <span id="pstats">0</span>% video processing completed.
                </div>
            </div>
            <div id="info">
            </div>
