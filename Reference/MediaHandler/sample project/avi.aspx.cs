...
public partial class avi : System.Web.UI.Page
{
    ...
    public static string EncodeVideo()
    {
        ...
        _mhandler.VCodec = "mpeg4"; // "libxvid"; 
        _mhandler.Parameters = "-vtag xvid";
        _mhandler.ProcessMedia();
        return _mhandler.vinfo.ErrorCode.ToString();
    }//ffmpeg -i input.avi -vcodec libxvid output.avi  //ffmpeg -i input.avi -vcodec mpeg4 -vtag xvid output.avi
