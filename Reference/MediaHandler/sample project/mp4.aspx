<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/main.master" CodeFile="mp4.aspx.cs"
    Inherits="mp4" %>

<asp:Content ID="head" ContentPlaceHolderID="hd" runat="server">
    <title>ASP.NET Media Handler Pro - MP4 Encoding Example</title>
</asp:Content>
 ...
 <div style="padding-left: 30px;">
     ...
     <div class="item_pad_2">
        ...
        <div class="item_pad_2">
            ...
            <br />
            Output File Name: /contents/mp4/wildlife.mp4
        </div>
