<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="flv.aspx.cs"
    Inherits="flv" %>

<asp:Content ID="head" ContentPlaceHolderID="hd" runat="server">
    <title>ASP.NET Media Handler Pro - FLV Encoding Example</title>
</asp:Content>
    ...
    <div style="padding-left: 30px;">
        <script type="text/javascript">
            ...
            function GetProgressValue(intervalid) {
                $.ajax({
                    type: "POST",
                    url: "flv.aspx/GetProgressStatus",
                    data: "{}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (msg) {
        ...
        <div class="item_pad_2">
            <h2>
                Flash FLV Encoding</h2>
        </div>
        <div class="item_pad_2">
            Source File Name: /contents/original/wildlife.wmv
            <br />
            Output File Name: /contents/mp4/wildlife.flv
        </div>
